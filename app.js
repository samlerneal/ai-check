...
const I18N = {
  zh: {
    ...
    privacyTitle: '隐私承诺',
    privacyCopy1: '检测结果只存在当前页面会话中。关闭页面后，检测结果、粘贴内容和评分都会消失。',
  ...
  ru: {
    ...
    privacyCopy1: 'Результаты существуют только в текущей сессии страницы. После закрытия страницы результаты, вставленный текст и оценки исчезают.',
